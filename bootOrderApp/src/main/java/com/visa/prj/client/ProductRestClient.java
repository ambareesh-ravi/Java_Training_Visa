...
public class ProductRestClient {
	...
	private static void methodThree(RestTemplate template, String url) {
		...
		Product p = new Product(0, "Nike Bags", "Bags", 890.00, 50);
	...
	private static void methodTwo(RestTemplate template, String url) {
		...
		ResponseEntity<List<Product>> response = 
				template.exchange(url, HttpMethod.GET, null, //3rd parameter is what is coming from the class. For get there is no payload.
